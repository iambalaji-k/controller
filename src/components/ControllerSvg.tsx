  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <path d="M805.044 337L822.858 382.24H815.809L811 369H794.5L788.639 382.24H783L801.754 337H805.044ZM803 347L795.5 365.409H811L803 347Z" fill={pressedButtons.B ? '#fff' : '#a1a1aa'} pointerEvents="none" />
      </g>

      {/* A Button */}
      <g>
        <circle cx="804" cy="362" r="35" fill={getButtonFill('A', '#22222a')} stroke={pressedButtons.A ? brandColor : '#4b5563'} strokeWidth="1.5" />
        <path d="M861.808 272.086H875.222C884.706 272.086 888.935 277.17 888.935 283.065C888.935 287.807 886.287 291.267 882.1 292.976C887.483 293.916 891.028 298.06 891.028 303.955C891.028 311.303 885.646 315.746 877.273 315.746H861.808V272.086ZM867.191 276.315V290.883H872.616C879.879 290.883 883.339 287.807 883.339 282.937C883.339 278.75 880.263 276.315 874.24 276.315H867.191ZM867.191 294.898V311.046H876.205C882.228 311.046 885.304 308.227 885.304 302.972C885.304 297.675 880.519 294.898 872.872 294.898H867.191Z" fill={pressedButtons.A ? '#fff' : '#a1a1aa'} pointerEvents="none" />
      </g>
